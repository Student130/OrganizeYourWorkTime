    ...
    <div class="content">
        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <button  type = "submit" class="btn btn-primary btn-round btn-lg btn-block mb-3">{{ __('Zaloguj') }}</button>
                <div class="pull-left">
                    <h6>
                    <a href="{{ route('register') }}" class="link footer-link">{{ __('Utwórz konto') }}</a>
                    </h6>
                </div>
                <div class="pull-right">
                    <h6>
                    <a href="{{ route('password.request') }}" class="link footer-link">{{ __('Zapomniałeś hasło?') }}</a>
                    </h6>
                </div>
                </div>
            </div>
